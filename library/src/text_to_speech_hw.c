...
static volatile ISC_MSG_t   _last_req;
static volatile ISC_MSG_t   _last_rsp;
/******************************************************************************
* Function Prototypes
*******************************************************************************/
/* Writes data from output buffer through SPI */
void _write_req( void );
/* Reads data from SPI and feels the input buffer */
void _read_rsp( void );
/******************************************************************************
...
void tts_hw_init( void )
{
    ...
    _last_rsp.len[ 0 ] = 0;
    _last_rsp.len[ 1 ] = 0;
    memset( _last_rsp.payload, 0, MAIN_MESSAGE_MAX );
}
